  ...
  var rows = sorted.map(function(p){
    ...
    return '<tr>'+
      ...
      '<td><button class="pend-done-btn"'+
        ...
        ' style="background:rgba(88,176,49,.1);border:1px solid rgba(88,176,49,.3);border-radius:6px;padding:4px 10px;color:var(--green2);font-size:10px;font-weight:700;cursor:pointer;font-family:Inter,Arial,sans-serif">'+
